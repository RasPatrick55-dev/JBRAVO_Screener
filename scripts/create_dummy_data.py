...
def populate_dummy_data():
    ...
    top_candidates = [
        {"symbol": sym, "score": round(random.uniform(50, 100), 2)}
        for sym in random.sample(["AAPL", "MSFT", "GOOG", "AMZN", "META"], 5)
    ]
    ...
    metrics_summary = {
        ...
        "max_drawdown": round((cumulative - cumulative.cummax()).min(), 2)
